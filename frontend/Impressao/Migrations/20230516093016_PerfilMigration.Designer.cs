...
namespace Impressao.Migrations
{
    ...
    [Migration("20230516093016_PerfilMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Impressao.Models.Config", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AlturaThumb")
                        .HasColumnType("integer");

                    b.Property<double>("DPI")
                        .HasColumnType("double precision");

                    b.Property<int>("LarguraThumb")
                        .HasColumnType("integer");

                    b.Property<int>("MargemMidia")
                        .HasColumnType("integer");

                    b.Property<int>("MargemThumb")
                        .HasColumnType("integer");

                    b.Property<string>("PathFotos")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Impressao.Models.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Impressao.Models.Funcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Impressao.Models.PedidoItem", b =>
                {
                    ...
                    b.Property<DateTime?>("DataProcessamentoIndex")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("DataProcessamentoPreparacao")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("DataProcessamentoUpload")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Impressao.Models.Perfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Impressao.Models.PerfilFuncao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Impressao.Models.UsuarioPerfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Impressao.Models.PerfilFuncao", b =>
                {
                    b.HasOne("Impressao.Models.Funcao", "Funcao")
                        .WithMany("PerfilFuncoes")
                        .HasForeignKey("FuncaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Impressao.Models.Perfil", "Perfil")
                        .WithMany("PerfilFuncoes")
            ...
            modelBuilder.Entity("Impressao.Models.UsuarioPerfil", b =>
                {
                    ...
                    b.HasOne("Impressao.Models.Usuario", "Usuario")
                        .WithMany("UsuarioPerfis")
